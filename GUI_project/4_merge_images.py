...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        ...
        initialdir=r"C:\Users\J\PycharmProjects\pythonProject1\GUI_project")  # 최초에 사용자가 지정한 경로를 보여줌
...
# 이미지 통합
def merge_image():
    # print(list_file.get(1, END))  # 모든 파일 목록을 가지고 오기
    ...
    dest_path = os.path.join(txt_dest_path.get(), "jun_photo.jpg")
