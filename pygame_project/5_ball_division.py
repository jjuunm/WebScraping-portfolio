...
# 화면 타이틀 설정
pygame.display.set_caption("Jun Pang")    # 게임 이름
...
balls.append({
    ...
    "to_x" : 3,  # 공의 x축 이동방향, -3 이면 왼쪽으로, 3 이면 오른쪽으로
    "to_y" : -6,  # 공의 y축 이동방향
    "init_spd_y" : ball_speed_y[0]})  # y 최초 속도 정의
...
while running:
    ...
    # 무기 위치 조정
    # x = 100, y = 200 -> x = 100, y = 180, 160, 140, ...
    # x = 500, y = 200 -> x = 500, y = 180, 160, 140, ...
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        ...
                        "to_x": -3,  # 공의 x축 이동방향, -3 이면 왼쪽으로, 3 이면 오른쪽으로
                        "to_y": -6,  # 공의 y축 이동방향
                        "init_spd_y": ball_speed_y[ball_img_idx + 1]})  # y 최초 속도 정의
